...
const S={bg:"#0D0C0A",card:"#131210",border:"#252318",gold:"#C8A86A",goldDim:"#8A7040",text:"#E2D9C8",muted:"#6A6050",severe:"#D44040",moderate:"#C87030",mild:"#C4A830",green:"#6A9060",candida:"#906080",whey:"#5080A8",c1:"#1A1808",c2:"#B8A888",c3:"#9A7040",c4:"#161410"};
const CUISINES = [
...
Give: (1) most likely cause of this reaction, (2) what to monitor in the next 2h, (3) one protocol adjustment for next meal, (4) whether to flag to clinician. Keep it to 4 short paragraphs.`;
 ...
 const TABS = [{id:"monitor",label:"🔴 Monitor"},{id:"protocol",label:"Protocol"},{id:"rotation",label:"Rotation"},{id:"meals",label:"Meals"},{id:"generate",label:"Generate"},{id:"grocery",label:"🛒 Grocery"},{id:"lookup",label:"Food Check"},{id:"chat",label:"Ask Mario"}];
 const PHASES = [
        ...
        {(() => {
         ...
         return (
          <div style={{background:"#141008",border:`1px solid ${S.gold}25`,borderRadius:6,padding:"8px 10px",marginBottom:8,display:FX,justifyContent:"space-between",alignItems:"center"}}>
           ...
           <button onClick={()=>{ if(!alreadyLoaded) setMonFoods(templateFoods); else setMonFoods([]);}}
                       style={{background:alreadyLoaded?S.gold+"20":S.c1,border:`1px solid ${alreadyLoaded?S.gold:S.goldDim+"40"}`,borderRadius:5,padding:"4px 10px",cursor:CP,fontSize:10,fontFamily:FF,color:alreadyLoaded?S.gold:S.goldDim,whiteSpace:"nowrap",marginLeft:8,flexShrink:0}}>
