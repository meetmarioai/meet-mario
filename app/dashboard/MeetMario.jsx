...
const Nav = ({ showProgress, step }) => (
  <div style={{
    ...
    <div style={{display:"flex",alignItems:"center",gap:18}}>
      ...
      <a href="/pregnancy" style={{fontFamily:fonts.mono,fontSize:8,color:T.w5,textDecoration:"none",letterSpacing:"0.12em",border:`1px solid ${T.w3}`,borderRadius:5,padding:"4px 11px",display:"flex",alignItems:"center",gap:6,transition:"border-color .15s"}}
        onMouseEnter={e=>e.currentTarget.style.borderColor=T.rg}
        onMouseLeave={e=>e.currentTarget.style.borderColor=T.w3}>
        <div style={{width:6,height:6,borderRadius:"50%",background:"#8BAF8A"}}/>
        BABY BALANS
      </a>
