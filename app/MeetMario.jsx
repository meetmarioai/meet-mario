  ...
  const parseLabFile = async (file, isAdditional = false) => {
    ...
    reader.onload = async (e) => {
      ...
      try {
        ...
        const promptText = `This is a medical lab test result — likely an ALCAT food intolerance / immune reactivity report, or a CMA intracellular analysis, or blood work.

TASK: Scan the entire document carefully. Find ALL food names, substances, or analytes that have a reactivity class or level assigned to them.
...
If you cannot find any reactive foods, return: {"severe":[],"moderate":[],"mild":[]}`;
        ...
        const content = fileBlock
          ? [fileBlock, { type: 'text', text: promptText }]
